...
ic15_train_gt_dir=ic15_root_dir+'ch4_training_localization_transcripyion_gt/'
...
class PAN_IC15(data.Dataset):
    ...
    def prepare_train_data(self,index):
        ...
        img=img.convert('RGB')
        if self.is_transform:
            img=transfroms.ColorJitter(brightness=32.0/255,
                                       saturation=0.5)(img)

        img=transfroms.ToTensor()(img)
        img=transfroms.Normalize(mean=[0.485,0.456,0.406],
