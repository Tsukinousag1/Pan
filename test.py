...
def test(test_loader,model,cfg):
    ...
    for idx,data in enumerate(test_loader):
        ...
        #print(data['imgs'].shape)torch.Size([1, 3, 640, 1792])
        data.update(dict(
            cfg=cfg
        ))
        ...
        #save result
        #idx 对应的img_name  001.jpg ——>split 001 jpg
        #001
...
if __name__=='__main__':
    ...
    parser.add_argument('--checkpoint',default='/home/std2021/hejiabang/OCR/PAN/checkpoints/pan_r18_ctw/checkpoint.pth.tar',type=str,help='checkpoint path')
    parser.add_argument('--report_speed',default=None,type=int,help='report speed')
